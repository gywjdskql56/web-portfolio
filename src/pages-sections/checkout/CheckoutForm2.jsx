...
const Heading = ({
  ...
  return <FlexBox gap={1.5} alignItems="center" mb={3.5}>
      <Avatar sx={{
      width: 32,
      height: 32,
      color: "primary.text",
...
const CheckoutForm2 = () => {
  ...
  useEffect(() => {
    if (newAddress !== "") setAddressData([newAddress, ...addressData]);else setAddressData(addressList2);
  }, [newAddress]);
                ...
                right: 5
                  ...
                  mr: 1
                    ...
                    fontSize: 20
                      ...
                      <IconButton size="small" color="error" onClick={() => deleteAddress(item.name)}>
                        <DeleteOutline sx={{
                    fontSize: 20
                  }} />
                      </IconButton>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item sm={12} xs={12}>
                  ...
                  mx: 3
                    ...
                    <TextField fullWidth type="number" name="cardCVC" label="CVC/CVV" onChange={handleChange} value={values.cardCVC} error={!!touched.cardCVC && !!errors.cardCVC} helperText={touched.cardCVC && errors.cardCVC} />
                  </Box>
                </Grid>
              </Grid>
              <FormControlLabel sx={{
              ...
              <Grid container spacing={3}>
                ...
                borderColor: item.last4Digits === values.card ? "primary.main" : "transparent"
                      ...
                      <Box height={24} width={36} position="relative" mb={1}>
                        <LazyImage layout="fill" alt={item.name} objectFit="contain" src={`/assets/images/payment-methods/${item.cardType}.svg`} />
                      </Box>
