...
export default function AccountSetting() {
  ...
  return <Box py={4}>
      ...
      p: 4
        ...
        <Box mb={3} height="173px" overflow="hidden" borderRadius="10px" position="relative" style={{
        background: "url(/assets/images/banners/banner-10.png) center/cover"
          ...
          <Box position="absolute" bottom={20} left={24}>
            ...
            bgcolor: "grey.300"
              ...
              <Avatar src="/assets/images/faces/propic(9).png" sx={{
              width: 80,
              height: 80,
              border: "4px solid",
        ...
        <Formik onSubmit={handleFormSubmit} initialValues={INITIAL_VALUES} validationSchema={accountSchema}>
          {({
          values,
          errors,
          touched,
